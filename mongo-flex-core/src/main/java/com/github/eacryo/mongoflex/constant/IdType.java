 ...
 *   <tr><td>{@link #OBJECT_ID}</td><td>MongoDB 原生 ObjectId，由驱动自动生成</td><td>{@code String}（hex 格式，24 字符）</td></tr>
 ...
 */
public enum IdType {
    /** MongoDB native ObjectId, auto-generated by the driver. Stored as 24-char hex String on Java side. / MongoDB 原生 ObjectId，由驱动自动生成。Java 侧存储为 24 字符 hex 字符串。 */
    OBJECT_ID(0),
